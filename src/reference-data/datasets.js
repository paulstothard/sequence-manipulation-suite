export const referenceDataManifest = {
  ...
  "datasets": [
    ...
    {
      "id": "protein-digest",
      "name": "Protein digest specificity models",
      "fetchScript": null,
      "buildScript": "reference-data:build:protein-digest",
      "requiresNetworkForFetch": false,
      "offlineBuild": true,
      "generatedFiles": [
        "src/reference-data/protein-digest/records.json",
        "src/reference-data/protein-digest/records.js",
        "src/reference-data/protein-digest/provenance.json"
      ],
